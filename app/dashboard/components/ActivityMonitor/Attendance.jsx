      ...
      <Table className="rounded-2xl  w-full table-fixed bg-white">
        ...
        <TableHeader>
          <TableRow className="bg-[#F8F9FD] sticky top-0">
            <TableHead className="text-[#000000] text-[18px] w-[100px]">Date</TableHead>
            <TableHead className="text-[#000000] text-[18px] w-[100px] ">Class</TableHead>
            <TableHead className=" text-[#000000] text-[18px] w-[100px]"><div className="flex justify-start ml-16">Status</div> </TableHead>
            <TableHead className="text-right text-[#000000] text-[18px] w-[100px]">Notes</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
